...
try:
    ...
    def setup_filtered_material_dropdown(combo_box, filter_type):
        uniaxial_filter = lambda mat: mat.material_type == 'uniaxialMaterial'
        setup_material_dropdown(combo_box, uniaxial_filter, "Select Uniaxial Material")
