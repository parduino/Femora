...
1. **SP Constraints**: Single-point constraints that fix or control degrees of freedom at specific nodes
2. **MP Constraints**: Multi-point constraints that create relationships between multiple nodes
