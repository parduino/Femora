...
The ``Analysis`` component is a core part of the MeshMaker library that manages the configuration and execution of OpenSees analyses. It implements a comprehensive system for defining and controlling various types of structural analyses, including static, transient, and variable transient analyses.
...
2. **Through MeshMaker** (Recommended): Access via the MeshMaker class's .analysis property
...
.. autoclass:: meshmaker.components.Analysis.analysis.AnalysisManager
...
.. code-block:: python
   ...
   from meshmaker.components.Analysis.analysis import AnalysisManager
   from meshmaker.components.Analysis.constraint_handlers import PlainHandler
   from meshmaker.components.Analysis.numberers import PlainNumberer
   from meshmaker.components.Analysis.systems import BandGeneral
   from meshmaker.components.Analysis.algorithms import Newton
   from meshmaker.components.Analysis.convergenceTests import NormDispIncr
   from meshmaker.components.Analysis.integrators import LoadControl
